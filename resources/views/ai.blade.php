    ...
    <div class="flex flex-row gap-10 mx-4 lg:mx-[60px] mt-10 lg:mt-12">
        ...
        <div class="flex-1 flex flex-col gap-10">
            ...
            <section id="about" class="flex flex-col gap-4">
                ...
                <p class="text-lg font-normal">This new collaborative bootcamp delves into topics such as fundamentals
            ...
            <section class="bg-primary/10 p-4 lg:px-[60px] lg:py-[30px] rounded-[32px]">
                <h2 class="text-lg lg:text-3xl font-bold lg:font-medium text-text">What you will get</h2>
                <div class="gap-4 flex flex-row mt-4">
                    <div class="gap-4 flex flex-col">
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle" class="w-5" />
                            <p class="text-base lg:text-lg font-light">High quality professional network</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle" class="w-5" />
                            <p class="text-base lg:text-lg font-light">Unlimited Live Class</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle" class="w-5" />
                            <p class="text-base lg:text-lg font-light">Maximum 20-35 students per class (general)</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle" class="w-5" />
                            <p class="text-base lg:text-lg font-light">Career support (Career guidance, CV creation,
                                Interview simulation)</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle" class="w-5" />
                            <p class="text-base lg:text-lg font-light">Practical session</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                class="w-5" />
                            <p class="text-base lg:text-lg font-light">Proven method by Magic Session Clinic +</p>
                        </div>
                    </div>
                    <div class="gap-4 flex flex-col">
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                class="w-5" />
                            <p class="text-base lg:text-lg font-light">Hands on project based on Industry trend</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                class="w-5" />
                            <p class="text-base lg:text-lg font-light">Experienced Mentors to Assist Learning Within
                                and Beyond the Classroom</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                class="w-5" />
                            <p class="text-base lg:text-lg font-light">Business english course</p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                class="w-5" />
                            <p class="text-base lg:text-lg font-light">Apprenticeship program for real work experience
                            </p>
                        </div>
                        <div class="inline-flex gap-2 lg:gap-3">
                            <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                class="w-5" />
                            <p class="text-base lg:text-lg font-light">Management trainee access & Job simulation</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div id="accordion-collapse" data-accordion="collapse" class="mt-6">
                    ...
                    <h2 id="accordion-collapse-heading-1" onclick="accordian(event, 'accordion-collapse-body-1')">
                        <button type="button"
                            ...
                            <span class="font-semibold text-white text-2xl">Core topic</span>
                    ...
                    <h2 id="accordion-collapse-heading-2" onclick="accordian(event, 'accordion-collapse-body-2')">
                        <button type="button"
                            ...
                            <span class="font-semibold text-white text-2xl">Elective module</span>
                            <img src="../assets/vector/expand-more.svg" alt="Icon Expand More">
                        </button>
                    </h2>
                    ...
                    <h2 id="accordion-collapse-heading-3" onclick="accordian(event, 'accordion-collapse-body-3')">
                        <button type="button"
                            ...
                            <span class="font-semibold text-white text-2xl">Job Simulation</span>
                            <img src="../assets/vector/expand-more.svg" alt="Icon Expand More">
                        </button>
                    </h2>
                    ...
                    <h2 id="accordion-collapse-heading-4" onclick="accordian(event, 'accordion-collapse-body-4')">
                        <button type="button"
                            ...
                            <span class="font-semibold text-white text-2xl">Career Accelerator Journey</span>
                            <img src="../assets/vector/expand-more.svg" alt="Icon Expand More">
                        </button>
                    </h2>
            ...
            <section id="learning-phase">
                ...
                <div class="bg-secondary mt-6 p-4 lg:px-[60px] lg:py-[30px] rounded-[32px] text-white">
            ...
            <section id="proven-wethodology">
                ...
                <div class="grid grid-cols-2 gap-6 mt-6">
                    <div class="flex flex-col gap-2 p-6 bg-primary-light rounded-[32px]">
                        <div class="w-[72px] h-[72px] bg-container-icon rounded-full flex items-center justify-center">
                            <img src="../assets/vector/live-tv-w.svg" alt="Icon Live TV">
                        </div>
                        <h3 class="text-2xl font-semibold">Live classes every week</h3>
                        <p class="text-lg text-text font-normal">Pembelajaran live session diajarkan oleh para ahli di
                            bidangnya</p>
                    </div>
                    <div class="flex flex-col gap-2 p-6 bg-primary-light rounded-[32px]">
                        <div class="w-[72px] h-[72px] bg-container-icon rounded-full flex items-center justify-center">
                        ...
                        <h3 class="text-2xl font-semibold">Analytical thinking test improvement</h3>
                        <p class="text-lg text-text font-normal">Well designed-Evaluation to identify student’s
                            capabilities when participating in company recruitment</p>
                    </div>
                    <div class="flex flex-col gap-2 p-6 bg-primary-light rounded-[32px]">
                        <div class="w-[72px] h-[72px] bg-container-icon rounded-full flex items-center justify-center">
                            <img src="../assets/vector/user.svg" alt="Icon User">
                        </div>
                        <h3 class="text-2xl font-semibold">Limited student per class (avr max 35)</h3>
                        <p class="text-lg text-text font-normal">Kelas berkisar mulai dari 15 student hingga average
                            maksimum 35 students untuk menjaga kondusifitas kelas</p>
                    </div>
                    <div class="flex flex-col gap-2 p-6 bg-primary-light rounded-[32px]">
                        <div class="w-[72px] h-[72px] bg-container-icon rounded-full flex items-center justify-center">
                            <img src="../assets/vector/graduation-cap.svg" alt="Icon Live TV">
                        </div>
                        <h3 class="text-2xl font-semibold">Tutor+ 4.0</h3>
                        <p class="text-lg text-text font-normal">Tutor+ generasi ke-4 adalah layanan terbaru untuk
                            menciptakan productivity group discussion bersama tutor melalui whatsapp. Tanpa tambahan
                            biaya!</p>
                    </div>
                    <div class="flex flex-col gap-2 p-6 bg-primary-light rounded-[32px]">
                        <div class="w-[72px] h-[72px] bg-container-icon rounded-full flex items-center justify-center">
                            <img src="../assets/vector/talk.svg" alt="Icon Talk">
                        </div>
                        <h3 class="text-2xl font-semibold">Magic session clinic+</h3>
                        <p class="text-lg text-text font-normal">Klinik kelas pendalaman atau Magic Session Clinic+
                            disediakan untuk memahami lebih jauh materi dan studi kasus terkini diluar dari modul utama
                        </p>
                    </div>
                    <div class="flex flex-col gap-2 p-6 bg-primary-light rounded-[32px]">
                        <div class="w-[72px] h-[72px] bg-container-icon rounded-full flex items-center justify-center">
                            <img src="../assets/vector/game.svg" alt="Icon Live TV">
                        </div>
                        <h3 class="text-2xl font-semibold">Game & Hackathon</h3>
                        <p class="text-lg text-text font-normal">Join our online or offline hackathon (industry case &
            ...
            <section class="inline-flex gap-3 items-center" id="halal-guaranted">
                <div class="flex flex-col gap-4">
                    <div
                        ...
                        <img src="../assets/vector/mosque.svg" alt="Icon Mosque" class="w-6">
                        Halal Guaranteed
                    </div>
                    <h2 class="text-lg lg:text-3xl font-bold lg:font-medium text-text">Best resources, Halal at all.
                    </h2>
                    <p>First Bootcamp Platform wihtout overpromise marketing campaign, real result, focused on value of
                ...
                <img src="../assets/img/halal-indonesia.png" alt="Logo Halal Indonesia" class="w-[200px]">
            </section>
            <section id="alumni" class="bg-secondary p-4 lg:p-[30px] rounded-[32px] text-white">
                ...
                <div class="gap-6 flex flex-row mt-8">
                    <div class="flex-1 flex flex-col gap-6 rounded-3xl bg-secondary-light p-4">
                        ...
                        <a href="#program"
                            class="inline-flex gap-4 justify-center items-center h-10 bg-secondary rounded-full text-sm text-white font-bold">
            ...
            <section id="country-fees" class="flex flex-col">
                ...
                <div class="flex flex-row gap-4 mt-4">
                    <div class="p-4 lg:px-[60px] lg:py-[30px] border border-primary rounded-[32px]">
                        <div class="flex flex-col gap-4">
                            <h3 class="text-2xl text-text font-semibold text-center">International Student
                                <br /> (English & Turkiye)
                            </h3>
                            <h4 class="bg-primary-light rounded-full py-2 text-lg font-medium text-center">Pricing
                                <br> USD 1,300
                            </h4>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Lifetime career support</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Unlimited live class session with mentor</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Online materials</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Magic session clinic+</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Working Abroad Access</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Global Expert</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Down Payment Min 10%</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">30 Days money back guarantee</p>
                            </div>
                        </div>
                    ...
                    <div class="p-4 lg:px-[60px] lg:py-[30px] bg-primary/10 rounded-[32px]">
                        <div class="flex flex-col gap-4">
                            <h3 class="text-2xl text-text font-semibold text-center">Southeast Asia
                                <br /> (Bahasa Indonesia)
                            </h3>
                            <h4 class="bg-primary rounded-full py-2 text-lg text-white font-medium text-center">Career
                                Accelerator
                                <br /> IDR 15,000,000
                            </h4>
                            <div class="inline-flex gap-2 lg:gap-3">
                            ...
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                                <p class="text-base lg:text-lg font-light">Hybrid offline</p>
                            </div>
                            <div class="inline-flex gap-2 lg:gap-3">
                                <img src="../assets/vector/check-circle.svg" alt="Icon Checkmark Circle"
                                    class="w-5" />
                ...
                <div id="accordion-collapse" class="mt-6">
                    <h4 id="accordion-collapse-heading-1" onclick="accordian(event, 'bottom-accordion-collapse-body-1')">
                        <button type="button"
                            ...
                            data-accordion-target="#accordion-collapse-body-1" aria-expanded="true"
                            aria-controls="accordion-collapse-body-1">
                            <span class="font-medium text-text text-lg">Do you provide installment?</span>
                    ...
                    <h4 id="accordion-collapse-heading-2" onclick="accordian(event, 'bottom-accordion-collapse-body-2')">
                        <button type="button"
                            ...
                            data-accordion-target="#accordion-collapse-body-2" aria-expanded="false"
                            aria-controls="accordion-collapse-body-2">
                            <span class="font-medium text-text text-lg">Do you provide consultation directly with
                                tutor?</span>
                            <img src="../assets/vector/expand-more-b.svg" alt="Icon Expand More">
                        </button>
                    </h4>
                    ...
                    <h4 id="accordion-collapse-heading-3" onclick="accordian(event, 'bottom-accordion-collapse-body-3')">
                        <button type="button"
                            ...
                            data-accordion-target="#accordion-collapse-body-3" aria-expanded="false"
                            aria-controls="accordion-collapse-body-3">
                            <span class="font-medium text-text text-lg">Do you have make up class if i miss the
                                session?</span>
                            <img src="../assets/vector/expand-more-b.svg" alt="Icon Expand More">
                        </button>
                    </h4>
                    ...
                    <h4 id="accordion-collapse-heading-4" onclick="accordian(event, 'bottom-accordion-collapse-body-4')">
                        <button type="button"
                            ...
                            data-accordion-target="#accordion-collapse-body-4" aria-expanded="false"
                            aria-controls="accordion-collapse-body-4">
                            <span class="font-medium text-text text-lg">Maximum age to join this program ?</span>
                            <img src="../assets/vector/expand-more-b.svg" alt="Icon Expand More">
                        </button>
                    </h4>
