...
<body class="font-satoshi bg-body relative">
    ...
    <section class="w-full h-[423px] lg:h-[708px] px-4 lg:px-[60px] bg-center bg-cover text-white"
        style="background-image: url('../assets/img/hero-digital-marketing.png');">
        <div class="flex flex-col lg:w-[681px] gap-6 lg:gap-10">
            <h1 class="text-2xl lg:text-5xl font-bold mt-24 lg:mt-44 leading-10">Accelerate Your Career in Digital
                Marketing Analytics
            </h1>
            <p class="text-sm lg:text-2xl text-white/75 font-normal lg:font-light leading-normal">Experience the real
    ...
    <div class="flex flex-col lg:flex-row gap-10 mx-4 lg:mx-[60px] mt-[18px] lg:mt-12">
        <aside
            ...
            <h3 class="text-2xl text-text font-semibold">Course Details Digital Marketing</h3>
        ...
        <div class="lg:flex-1 flex flex-col gap-10">
            <section id="about" class="flex flex-col gap-4">
                ...
                <p class="text-sm lg:text-lg font-normal">Digital marketing analytics helps deliver conversion for
                    business. Higher conversion rates will convey higher profits and higher revenues.
                    <br />
                    You will focused to learn All digital ads channel, including Google, Meta Ads, All Ads metrics and
                    optimization, SEO, google analytics, data exploratorty, data analytics for ads, SQL, and data
                    visualization.
                    To support your full stack digital marketing skill, we also provide you digital branding strategy,
                    digital community activation strategy, social media management skill, and also influencer marketing
                    strategy.
                ...
                <div id="accordion-collapse" data-accordion="collapse" class="mt-6">
                    ...
                    <div id="accordion-collapse-body-1" aria-labelledby="accordion-collapse-heading-1">
                        <ul
                            ...
                            <li>01. Digital Marketing Fundamental</li>
                            <li>02. Meta Ads</li>
                            <li>03. Google Ads</li>
                            <li>04. Tiktok Ads</li>
                            <li>05. Linkedin</li>
                            <li>06. Organic Performance</li>
                            <li>07. Social Media Management</li>
                            <li>08. SEO</li>
                            <li>09. Google Analytics</li>
                            <li>10. Performance Marketing</li>
                        </ul>
                    </div>
                    ...
                    <div id="accordion-collapse-body-2" aria-labelledby="accordion-collapse-heading-2">
                        <ul
                            ...
                            <li>01. Building Digital Marketing Agency</li>
                            <li>02. Digital Marketing for E-commerce</li>
                            <li>03. Small Medium Enterprises Ads</li>
                            <li>04. SEO Intermediate</li>
                            <li>05. Branding</li>
                            <li>06. CRM</li>
                            <li>07. Landing Page</li>
                            <li>08. Copywriting</li>
                            <li>09. Desiging Content</li>
                        </ul>
                    </div>
                ...
                <div
                    ...
                    <div class="gap-6 flex flex-col lg:flex-row mt-8">
                        <div class="flex-1 flex flex-col items-center h-[228px] rounded-3xl bg-secondary-light p-4">
                            <img src="../assets/vector/computer-check.svg" alt="Computer Check Icon">
                            <p class="text-base mt-3 text-center"><b>Month 1 :</b>
                                <br />Fundamental of Digital ecosystem & ads channel
                            </p>
                        </div>
                        <div class="flex-1 flex flex-col items-center h-[228px] rounded-3xl bg-secondary-light p-4">
                            <img src="../assets/vector/add-reaction-w.svg" alt="Happy Icon">
                            <p class="text-base mt-3 text-center"><b>Month 2 :</b>
                                <br />Social media organic, traffic, landing page & ads channel
                            </p>
                        </div>
                        <div class="flex-1 flex flex-col items-center h-[228px] rounded-3xl bg-secondary-light p-4">
                            <img src="../assets/vector/blood-pressure.svg" alt="Performance Icon">
                            <p class="text-base mt-3 text-center"><b>Month 3 :</b>
                                <br />SEO & Performance marketing
                            </p>
                        </div>
                        <div class="flex-1 flex flex-col items-center h-[228px] rounded-3xl bg-secondary-light p-4">
                            <img src="../assets/vector/approval-delegation.svg" alt="Custommer Approval Icon">
                            <p class="text-base mt-3 text-center"><b>Month 4 :</b>
                                <br />Customer Relationship Management & Final Project
                            </p>
                        </div>
                    </div>
                </div>
